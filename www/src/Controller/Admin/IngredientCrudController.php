...
class IngredientCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('label', 'Nom de l\'Ingrédient'),
            AssociationField::new('category', 'Catégorie')
                ->setFormTypeOptions([
                    'by_reference' => false,
                ])
                ->autocomplete()
                ->setCustomOption('choice_label', function (?Category $category) {
                    return $category ? $category->getLabel() : ''; // Utilisez getLabel() pour afficher le nom
                }),
        ];
    }
